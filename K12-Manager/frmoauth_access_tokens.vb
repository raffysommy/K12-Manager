...
Namespace K12_Manager
	...
	Public Class frmoauth_access_tokens
		
		Private ad As MySqlDataAdapter
		
		Private Sub frmoauth_access_tokens_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
            ...
            ad = New MySqlDataAdapter("select * from `oauth_access_tokens`", strConn)
            Dim builder As MySqlCommandBuilder = New MySqlCommandBuilder(ad)
            ad.Fill(Me.newDataSet.oauth_access_tokens)
			...
			Dim colaccess_token As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn()
			colaccess_token.DataPropertyName = "access_token"
			colaccess_token.HeaderText = "access_token"
			colaccess_token.Name = "colaccess_token"
			dataGridView1.Columns.Add(colaccess_token)
			...
			Me.dataGridView1.DataSource = Me.oauth_access_tokensBindingSource
		End Sub
		...
		Private Sub ToolStripButton1_Click(sender As System.Object, e As System.EventArgs) Handles ToolStripButton1.Click
			If Not Me.Validate() Then
				Return
			End If
			If TypeOf( CType(oauth_access_tokensBindingSource.Current, DataRowView )( "expires" ) ) Is DBNull Then 
				CType(oauth_access_tokensBindingSource.Current, DataRowView )("expires") = DateTime.Now
			End If
			oauth_access_tokensBindingSource.EndEdit()
			ad.Update(Me.newDataSet.oauth_access_tokens)
		End Sub
		
		Private Sub frmoauth_access_tokens_FormClosing(sender As System.Object, e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
			e.Cancel = False
		End Sub
		...
		Private Sub dataGridView1_CellValidating(sender As Object, e As DataGridViewCellValidatingEventArgs)
			...
			If e.ColumnIndex = 0 Then
				...
				If (TypeOf value is DBNull) OrElse String.IsNullOrEmpty( value.ToString() ) Then 
					e.Cancel = True
					row.ErrorText = "The field access_token is required"
					Return
				End If
			End If
		...
		Private Sub bindingNavigatorAddNewItem_Click(sender As System.Object, e As System.EventArgs)
			oauth_access_tokensBindingSource.AddNew()
		End Sub
